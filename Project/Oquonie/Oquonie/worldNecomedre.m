...
-(void)createWorldNecomedre
{
	...
	@"4",@"2",@"2",
	// Walls
	@"26",@"16|event|map",@"26",@"19",@"12|warp|33|0,-1",@"19",
	// Steps
	...
	worldNode[35] = @[
	// Tiles
	@"4",@"4",@"4|event|ramen|7|r",
	@"4",@"4",@"4",
	@"4",@"4",@"4|event|speakerphone|9|l",
	// Walls
